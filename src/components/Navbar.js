  ...
  return (
    <div className="flex justify-between items-center px-12 p-3 text-sm font-bold">
      ...
      <div className="lg:hidden">
        <button
          onClick={handleNav}
          className="inline-flex items-center rounded-md py-2 px-4 text-sm font-bold bg-black/5 hover:bg-black/10 transition duration-200 ease-linear shadow-sm"
        >
          Menu
        </button>
      </div>
      <div
        className={
          nav
            ? "bg-white absolute top-0 right-0 w-full h-full z-10 transition duration-400 ease-in-out opacity-100"
            : "fixed right-[100%] opacity-0 transition duration-500 ease-in-out"
        }
      >
        <div className="flex justify-end pr-5 pt-4 hover:bg-black/5> cursor-pointer">
